...
Writing JS code is easy when you always use `<div/>`, right? </br>
...
`section` 👉🏻 groups related content on a page.<br/>
`article` 👉🏻 is a self-contained piece of content.<br/>
`figure` 👉🏻 is just for media with an optional caption.

   ###### References code inside the repository:<br> 
